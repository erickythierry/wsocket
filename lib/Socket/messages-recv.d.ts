...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    sendSecretGroupMessage: (jid: string, originalMessageObject: import("../Types").AnyMessageContent, fakeMessageObject: import("../Types").AnyMessageContent, options?: import("../Types").SecretGroupMessageOptions) => Promise<proto.WebMessageInfo>;
