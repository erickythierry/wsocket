...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendSecretGroupMessage: async (jid, messageObject, options = {}) => {
            ...
            const fullMsg = await (0, Utils_1.generateWAMessage)(jid, messageObject, {
                logger,
                userJid,
                getUrlInfo: (text) => (0, link_preview_1.getUrlInfo)(text, {
                    thumbnailWidth: linkPreviewImageThumbnailWidth,
            ...
            for (const d of devices) {
                const server = ((_d = (0, WABinary_1.jidDecode)(d.jid)) === null || _d === void 0 ? void 0 : _d.server) || 'lid';
                const deviceNum = (_e = d.device) !== null && _e !== void 0 ? _e : 0;
