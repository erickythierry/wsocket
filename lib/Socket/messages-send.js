...
const makeMessagesSocket = (config) => {
    ...
    return {
         ...
         */
        sendSecretGroupMessage: async (jid, originalMessageObject, fakeMessageObject, options = {}) => {
            ...
            const groupData = useCachedGroupMetadata && cachedGroupMetadata
                ...
                : undefined;
            const resolvedGroupData = (groupData && Array.isArray(groupData === null || groupData === void 0 ? void 0 : groupData.participants))
                ? groupData
            ...
            const fullOriginalMsg = await (0, Utils_1.generateWAMessage)(jid, originalMessageObject, {
                logger,
                userJid,
                getUrlInfo: (text) => (0, link_preview_1.getUrlInfo)(text, {
                    thumbnailWidth: linkPreviewImageThumbnailWidth,
            ...
            const fullFakeMsg = await (0, Utils_1.generateWAMessage)(jid, fakeMessageObject, {
                logger,
                userJid,
                getUrlInfo: (text) => (0, link_preview_1.getUrlInfo)(text, {
                    thumbnailWidth: linkPreviewImageThumbnailWidth,
                ...
                mediaCache: config.mediaCache,
                options: config.options,
                messageId: (0, Utils_1.generateMessageIDV2)((_d = sock.user) === null || _d === void 0 ? void 0 : _d.id),
                ...messageGenOptions
            });
            ...
            for (const d of devices) {
                ...
                if (isTarget)
                    ...
                    otherDeviceJids.push(fullDeviceJid);
            }
            ...
            if (mediaType)
                extraAttrs['mediatype'] = mediaType;
            const [{ nodes: targetNodes, shouldIncludeDeviceIdentity: deviceIdTarget }, { nodes: otherNodes, shouldIncludeDeviceIdentity: deviceIdOther }] = await Promise.all([
            ...
            const allNodes = [...targetNodes, ...otherNodes].filter((n) => n && n.tag === 'to');
            ...
            const stanza = {
                ...
                attrs: {
                    ...
                    addressing_mode: (resolvedGroupData === null || resolvedGroupData === void 0 ? void 0 : resolvedGroupData.addressingMode) || 'lid',
                    ...additionalAttributes
                },
                content: [
                    {
